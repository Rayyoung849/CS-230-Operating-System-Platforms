...
@Path("/gameusers") // Base URL for this controller,gameusers
...
public class GameUserRESTController {
	...
	// FIXME: Add RolesAllowed annotation for USER based on BasicAuth Security
	@RolesAllowed("USER") // Only users with role USER can access by id lookups
	@GET
	@Path("/{id}")
	...
	// FIXME: Add RolesAllowed annotation for ADMIN based on BasicAuth Security
	@RolesAllowed("ADMIN") // Only admins can create/update via POST here
	@POST
