...
public class GameAuthApplication extends Application<Configuration> {
	...
	public void run(Configuration c, Environment e) throws Exception {
		...
		// Expose gameusers REST endpoints by registering the controller.
		...
		// Example)
		// Build a reusable HTTP client named DemoRESTClient from the Dropwizard environment.
		Client client = new JerseyClientBuilder(e).build("DemoRESTClient");

		// Register the client facing controller so /client/ endpoints work
